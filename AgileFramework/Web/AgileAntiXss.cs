...
{
    public static class AgileAntiXss
    {
        /// <summary>
        /// HTML非法字符集
        /// </summary>
        private static Dictionary<int, string> chars = new Dictionary<int, string>();

        /// <summary>
        /// 5位数字码正则表达式
        /// </summary>
        private static Regex regex = new Regex(@"&#(\d{5});", RegexOptions.Compiled);
