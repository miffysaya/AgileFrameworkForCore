...
namespace AgileFramework.Security.Exchange.CtsResources
{
    internal static class TextConvertersStrings
    {
        ...
        public static string InputEncodingRequired
        {
            get
            {
                return ResourceManager.GetString("InputEncodingRequired");
            }
        }
        ...
        public static string ConverterWriterInInconsistentStare
        {
            get
            {
                return ResourceManager.GetString("ConverterWriterInInconsistentStare");
            }
        }
        ...
        public static string TagTooLong
        {
            get
            {
                return ResourceManager.GetString("TagTooLong");
            }
        }
        ...
        public static string WriteAfterFlush
        {
            get
            {
                return ResourceManager.GetString("WriteAfterFlush");
            }
        }
        ...
        public static string TooManyIterationsToFlushConverter
        {
            get
            {
                return ResourceManager.GetString("TooManyIterationsToFlushConverter");
            }
        }
        ...
        public static string TooManyIterationsToProduceOutput
        {
            get
            {
                return ResourceManager.GetString("TooManyIterationsToProduceOutput");
            }
        }
        ...
        public static string TooManyIterationsToProcessInput
        {
            get
            {
                return ResourceManager.GetString("TooManyIterationsToProcessInput");
            }
        }
        ...
        public static string CannotWriteWhileCopyPending
        {
            get
            {
                return ResourceManager.GetString("CannotWriteWhileCopyPending");
            }
        }
        ...
        public static string ParametersCannotBeChangedAfterConverterObjectIsUsed
        {
            get
            {
                return ResourceManager.GetString("ParametersCannotBeChangedAfterConverterObjectIsUsed");
            }
        }
        ...
        public static string WriteUnsupported
        {
            get
            {
                return ResourceManager.GetString("WriteUnsupported");
            }
        }
        ...
        public static string ContextNotValidInThisState
        {
            get
            {
                return ResourceManager.GetString("ContextNotValidInThisState");
            }
        }
        ...
        public static string ReadUnsupported
        {
            get
            {
                return ResourceManager.GetString("ReadUnsupported");
            }
        }
        ...
        public static string SeekUnsupported
        {
            get
            {
                return ResourceManager.GetString("SeekUnsupported");
            }
        }
        ...
        public static string ConverterStreamInInconsistentStare
        {
            get
            {
                return ResourceManager.GetString("ConverterStreamInInconsistentStare");
            }
        }
        ...
        public static string HtmlNestingTooDeep
        {
            get
            {
                return ResourceManager.GetString("HtmlNestingTooDeep");
            }
        }
        ...
        public static string ConverterReaderInInconsistentStare
        {
            get
            {
                return ResourceManager.GetString("ConverterReaderInInconsistentStare");
            }
        }
