using AgileFramework.Security.Application.CodeCharts;
using System;
...
namespace AgileFramework.Security.Application
{
    ...
    internal static class SafeList
    {
        ...
        /// <param name="generateSafeValue">The <see cref="T:Microsoft.Security.Application.GenerateSafeValue" /> function to use.</param>
